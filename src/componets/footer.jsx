function Footer (){
    ...
    <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">            
            <div>
                <h2 className="my-5 text-sm font-semibold text-gray-900 uppercase text-[#f46b19]">Nosotros</h2>
            ...
            <div className="ml-20">
                ...
                <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
                        <a href="https://github.com/themesberg/flowbite" className="hover:underline ">Coffee Harvest Help</a>
                    </li>
                    <li className="mb-4">
                        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Sevicio</a>
                    </li>
                    <li>
                        <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Objetivo</a>
                    </li>
                </ul>
            </div>         
        </div>                    
