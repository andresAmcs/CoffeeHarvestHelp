...
function Desyerva(props) {
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            lote: Yup.string()    
                .required("Debe de ingresar el lote que desyervó"),            
            ...
            valor: Yup.number()                    
                .required('Debe ingresar el costo de la desyerva')
    ...
    return (        
        ...
        <Toaster/>          
                    <div className="w-100% text-center">
                        <h2 className="font-medium leading-tight text-4xl mt-0 mb-2 text-amber-600">Desyerva</h2>
                    </div>
