...
function AplicacionFertilizantes(props) {
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            lote: Yup.string()    
                .required("Debe de ingresar el lote que fertilizó"),            
    ...
    <div className="md:w-[80%] md:m-auto md:my-10 2xl:w-1/2 bg-[#ffffff43] p-6 rounded-lg shadow-xl py-10 mt-10 mx-2 ">
          <Toaster/>
                    <div className="w-100% text-center">
                        <h2 className="font-medium leading-tight text-4xl mt-0 mb-2 text-amber-600">Aplización de fertilizantes</h2>
                    </div>
...
export default AplicacionFertilizantes