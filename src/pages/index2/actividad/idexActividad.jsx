          ...
          {data.map((data) => (
            <tr  key={data.id} className=" border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td scope="col" className=" ">
                  <button onClick={() => navigate(`/empleado/${data.id}`)}><i className="mt-2 mx-5 fa-solid fa-eye text-green-500"></i></button>
                  <button onClick={() => navigate(`/empleado/editar/${data.id}`)}><i className="my-5 mx-5 fa-solid fa-pen text-yellow-500"></i></button>
                  <button onClick={() => deleteEmpleado(data.id)}><i className="mb-2 mx-5 fa-solid fa-trash text-red-500"></i></button>
                </td>
